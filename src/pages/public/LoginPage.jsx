...
const LoginPage = () => {
    ...
    return (
        <div className='pageTemplate1'>
            {/* <div>Left</div> */}
            <div className='max-sm:hidden flex-1 min-h-[600px] h-4/5 bg-gradient-to-tr from-[#DAC6FB] to-[#AAC1F6] flex flex-col justify-center items-center rounded-l-2xl'>
            ...
            <form
                ...
                <div className='px-4 mt-2 mb-6 w-9/12 flex gap-2'>
                    ...
                    <Link to={PATH_PUBLIC.register} className='text-[#754eb4] border border-[#754eb4] hover:shadow-[0_0_5px_2px_#754eb44c] px-3 rounded-2xl duration-200'>Register</Link>
                </div>
